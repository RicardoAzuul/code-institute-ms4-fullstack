...
class TestViews(TestCase):
    def test_get_workouts(self):
        """
        When browsing to /workouts/ we get a 302 code,
...
class TestModels(TestCase):
    ...
    def setUp(self):
        self.test_bodypart = BodyPart.objects.create(name="test_bodypart")

        self.test_equipment = Equipment.objects.create(name="test_equipment")

        self.test_target = Target.objects.create(name="test_target")
    ...
    def test_delete_fields_of_workout(self):
        """
        When the bodypart, equipment and target
        objects are deleted for a workout,
    ...
    def test_all_blank_bodypart(self):
        """
        When a bodypart is created with no
    ...
    def test_friendly_name_blank_bodypart(self):
        """
        When a bodypart is created, friendly name is blank
        """
        bodypart = BodyPart.objects.create(name="test_part")
        self.assertFalse(bodypart.friendly_name)

    def test_max_length_name_bodypart(self):
        """
        When a bodypart is created with a name longer than
    ...
    def test_all_blank_equipment(self):
        """
        When a equipment is created with no
        info, we get a ValidationError
        """
    ...
    def test_friendly_name_blank_equipment(self):
        """
        When a equipment is created, friendly name is blank
        """
        equipment = Equipment.objects.create(name="test_equipment")
        self.assertFalse(equipment.friendly_name)

    def test_max_length_name_equipment(self):
        """
        When a equipment is created with a name longer than
        254 characters, we get a ValidationError
        """
        long_name = "x" * 255
    ...
    def test_all_blank_target(self):
        """
        When a target is created with no
        info, we get a ValidationError
        """
    ...
    def test_friendly_name_blank_target(self):
        """
        When a target is created, friendly name is blank
        """
        target = Target.objects.create(name="test_target")
        self.assertFalse(target.friendly_name)

    def test_max_length_name_target(self):
        """
        When a target is created with a name longer than
        254 characters, we get a ValidationError
        """
        long_name = "x" * 255
    ...
    def test_blank_name_workout(self):
        """
        When a workout is created with no name,
    ...
    def test_blank_description_workout(self):
        """
        When a workout is created with no description,
        we get a ValidationError
        """
    ...
    def test_blank_image_workout(self):
        """
        When a workout is created with no image,
        we get a ValidationError
        """
        with self.assertRaises(ValidationError):
            workout = Workout.objects.create(
    ...
    def test_blank_fields_workout(self):
        """
        When a workout is created, bodypart, equipment,
    ...
    def test_max_length_name_workout(self):
        """
        When a workout is created with a name
